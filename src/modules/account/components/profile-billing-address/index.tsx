...
const ProfileBillingAddress: React.FC<MyInformationProps> = ({
  ...
  const currentInfo = useMemo(() => {
    if (!billingAddress) {
      return "Fatura adresi belirtilmemiş"
    }
    ...
    return (
      <div className="flex flex-col font-bold text-gray-700" data-testid="current-info">
        <span>
          {billingAddress.first_name} {billingAddress.last_name}
        </span>
        <span className="text-gray-500 font-medium">{billingAddress.company}</span>
